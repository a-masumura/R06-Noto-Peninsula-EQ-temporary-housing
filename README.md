...
- **「建築タイプ」**　　String
  ...
  - 従来型について、このデータでは「プレハブ型（組立ハウス）」「プレハブ型（ユニットハウス）」「トレーラーハウス型」「ムービングハウス型」に細分化しています。
  ...
  - 内灘町はウェブサイトに各団地の位置図、建築タイプを掲載しています。こちらも参考にしています。（[石川県内灘町　建設型応急住宅の申込受付について](https://www.town.uchinada.lg.jp/site/earthquake/15940.html)）
